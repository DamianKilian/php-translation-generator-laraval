            ...
            <div class="d-flex">
                <div :class="{ open: sidePanelOpen }" class="side-panel d-flex">
                    <div class="settings flex-grow-1">
                        <div class="sticky-top"><h2 class="text-white bg-secondary text-center">{{ langCode }}</h2></div>
                    </div>
                    <div class="btns px-3">
                        <div class="sticky-top">
                            <div @click="sidePanelOpen = !sidePanelOpen" class="openSettings btn-svg"><svg
                            ...
                            <div class="save btn-svg"><svg xmlns="http://www.w3.org/2000/svg" width="64" height="64"
